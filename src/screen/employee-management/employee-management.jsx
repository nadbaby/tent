...
import { Users, UserPlus, Trash2, Edit2, Mail, Shield, User, Phone, Package, RefreshCw, Filter, CheckCircle, Calendar, LifeBuoy } from 'lucide-react';
...
const StaffOperationsDashboard = () => {
  ...
  const isSuperAdmin = currentUser?.role?.toLowerCase() === 'admin' || currentUser.email === 'dipanshu@pvtchopra.com';
