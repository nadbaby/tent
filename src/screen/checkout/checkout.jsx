...
const Checkout = () => {
  ...
  // Scroll to top on navigation to fix white page issue
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  if (!token) {
    return null; // Prevents flashing the checkout layout before redirect completes
  }
                  ...
                  <div className="form-grid">
                    ...
                    {deliveryMethod === 'PORTER' && (
                      <div className="form-group full porter-details-section" style={{
                        ...
                        <div className="porter-input-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
