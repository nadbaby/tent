...
import aiAssistantLogo from '../../assets/ai-assistant-logo.webp';
...
const Chatbot = () => {
  ...
  // Hide on order success/failure, log in, checkout, and admin pages
  const hiddenPaths = ['/order-success', '/order-failure', '/login', '/checkout', '/verify-email', '/quote'];
  const isHidden = hiddenPaths.includes(location.pathname) ||
    location.pathname.startsWith('/admin') ||
    location.pathname.startsWith('/employee-panel');

  // Hide logic moved to bottom to prevent Hook rule violations
  useEffect(() => {
